...
class Graph:
    ...
    def getType(self):
        ...
        graph_Type = ["GRID","ERDOS-RENYI","GILBERT","GEOGRAPHIC_SIMPLE","BARABASI-ALBERT","DOROGOVRSEV-MENDES","BFS_TREE","DFS_R_TREE","DFS_I_TREE","DIJKSTRA_TREE"]
    ...
    def getGenerator(self):
        ...
        if self.generator ==100:
            ...
            graph_Generator_Type = ["GRID","ERDOS-RENYI","GILBERT","GEOGRAPHIC_SIMPLE","BARABASI-ALBERT","DOROGOVRSEV-MENDES","BFS_TREE","DFS_R_TREE","DFS_I_TREE","DIJKSTRA_TREE"]
